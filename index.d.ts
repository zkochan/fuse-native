...
declare class Fuse {
    constructor(mnt: string, ops?: FuseNative.OPERATIONS, opts?: FuseNative.OPTIONS);
    ...
    public opts: FuseNative.OPTIONS;
    public mnt: string;
    public ops: FuseNative.OPERATIONS;
...
export as namespace FuseNative;
